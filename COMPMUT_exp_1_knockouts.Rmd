...
knit: (function(inputFile, encoding) {
  rmarkdown::render(inputFile, encoding = encoding, output_dir = "formatted_docs") })
---
...
However, I will proceed with this modelling approach as, though the Shapiro-Wilk test is significant, the significance is not large (p ~ 0.01), and nonparametric alternatives are not available.
...
**[On to COMPMUT experiments 2: Presentation and analysis of plasmid mutant fitness.](COMPMUT_exp_2_plasmids.html)**
