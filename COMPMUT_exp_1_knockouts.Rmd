...
However, I will proceed with this modelling approach as though the Shapiro-Wilk test is significant, the effect is not large (p ~ 0.01), and nonparametric alternatives are not available.
...
```{r}
posthoc_gls <- lsmeans(mod1_1, pairwise ~ host * plasmid, adjust="mvt")
...
Overall, very similar. Neglecting correlation between replicates means that a significant effect of gacS is detected with pQBR57, but otherwise there is no big effect of accounting for correlation between replicates.
