...
The pattern for pQBR103 is very different from that of pQBR57, with a large number of upregulated genes in both compensated variants. These include the transfer genes, and the pilus genes which are downregulated in pQBR57.
